	...
	const data: any = {
		hospital: [
			{
				...
				subject: 'Are the hospitals displayed on the site reliable?',
				content: 'of course we only have verified hospitals',
			},
			{
				id: '00f5a45ed8897f8090116a22',
				subject: 'What types of hospitals do you offer?',
				content: 'We offer single-family homes, condos, townhouses, apartments, and penthouses',
			},
			{
				id: '00f5a45ed8897f8090116a21',
				subject: 'How can I search for hospitals on your website?',
				content: 'Simply use our search bar to enter location, price range, bedrooms/bathrooms, and hospital type.',
			},
			{
			...
			},
			{
				...
				subject: 'What should I consider when buying a hospital?',
			...
			},
			{
				...
				subject: 'What happens if I encounter issues with the hospital after purchase?',
				content: 'We offer post-purchase support to address any concerns promptly.',
			},
			{
				id: '00f5a45ed8897f8090116a28',
				subject: 'Do you offer hospitals in specific neighborhoods?',
				content: 'Yes, we have listings in various neighborhoods based on your preferences.',
			},
			{
				id: '00f5a45ed8897f8090116a27',
				subject: 'Can I sell my hospital through your website?',
				content: 'Absolutely, we provide services for selling hospitals as well.',
			},
			{
				id: '00f5a45ed8897f8090116b99',
				subject: 'What if I need help understanding legal aspects of hospital purchase?',
		...
		payment: [
			...
			},
			{
				...
				content: 'Yes, we offer installment payment plans for certain hospitals. Please inquire for more details.',
			},
			{
		...
		buyers: [
			{
				...
				content: 'Buyers should check and decide whether the hospital they want to buy or rent is actually suitable!',
			},
			{
				id: '00f5a45ed8897f8090116a85',
				subject: 'How can I determine if a hospital is within my budget?',
				content:
			...
			},
			{
				...
				subject: 'What documents do I need to provide when purchasing a hospital?',
				content:
			...
			},
			{
				...
				subject: 'Can I negotiate the price of a hospital?',
				content:
					'Yes, you can negotiate the price of a hospital. Our agents will assist you in making competitive offers and negotiating terms with the seller.',
			},
			{
				id: '00f5a45ed8897f8090116a81',
				subject: 'What are some red flags to watch out for when viewing hospitals?',
				content:
			...
			},
			{
				...
				subject: 'Do you provide assistance with hospital inspections?',
				content:
					'Yes, we can recommend reputable inspectors and accompany you during hospital inspections to identify any potential issues.',
			},
			{
				id: '00f5a45ed8897f8090116a79',
				subject: 'How long does it typically take to find the right hospital?',
				content:
					'The timeframe varies depending on your preferences and market conditions. Our agents will work diligently to find the right hospital as quickly as possible.',
			},
			{
				id: '00f5a45ed8897f8090116a78',
				subject: 'What are the advantages of using a real estate agent when buying a hospital?',
				content:
			...
			},
			{
				...
				subject: 'What happens if I change my mind about a hospital after making an offer?',
				content:
		...
		agents: [
			...
			},
			{
				...
				subject: 'What are some effective marketing strategies for selling hospitals?',
		...
		membership: [
			...
			},
			{
				...
				subject: 'Do members receive discounts on hospital listings or services?',
		...
		return (
			<Stack className={'faq-content'}>
				<Box className={'categories'} component={'div'}>
					<div
						className={category === 'hospital' ? 'active' : ''}
						onClick={() => {
							changeCategoryHandler('hospital');
						}}
					>
						Hospital
					</div>
